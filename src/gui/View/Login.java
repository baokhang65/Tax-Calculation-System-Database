...
public class Login extends javax.swing.JPanel {
    ...
    if (username.isEmpty() || password.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Please enter all the required information.", "Notification", JOptionPane.WARNING_MESSAGE);
        return;
    }

        // Kết nối tới cơ sở dữ liệu và kiểm tra tài khoản admin
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(query)) {
                ...
                try (ResultSet rs = pstmt.executeQuery()) {
                    if (rs.next() && rs.getInt(1) > 0) {
                        ...
                        cardLayout.show(this.getParent(), "inputCard");
                    } else {
